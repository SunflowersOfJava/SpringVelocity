 ...
 * JavaBean 克隆类
 * 
 * @packge com.wlyd.fmcgwms.util.BeanClone
 * @date 2016年4月28日 下午5:25:06
 * @author pengjunlin
 * @comment
 * @update 添加注释,代码重构
 */
public class BeanClone {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static Object isLangType(Class c, Object value, int level)
	...
	public static Object clone(Object value, int level)
		...
		if (value instanceof Collection) {// 复制新的集合
			...
			// 首先判断是否为基本数据类型
			value = BeanClone.isLangType(c, value, level);
